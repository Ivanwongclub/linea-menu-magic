...
export const mockRFQs: RFQ[] = [
  {
    ...
    itemName: '金屬四孔鈕扣 18mm',
    category: '鈕扣',
    quantity: 10000,
    targetPrice: 0.15,
    targetDate: '2024-02-15',
    notes: '需要霧面金色電鍍處理，邊緣需圓潤。參考附件圖片。',
...
export const statusLabels: Record<RFQStatus, string> = {
  submitted: '待處理',
  model_uploaded: '模型已上傳',
  design_confirmed: '設計確認',
  ready_for_printing: '準備列印',
  printing: '3D列印中',
  shipped: '已出貨',
  sample_review: '樣品審核',
  production: '生產確認',
