    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-6 lg:p-8">
        ...
        <span className="text-xs uppercase tracking-[0.1em] text-white/60 mt-1 inline-flex items-center gap-1 transition-all duration-[420ms] ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:gap-2">
          {t("home.products.explore")} <span className="transition-transform duration-[420ms] ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:translate-x-1">→</span>
        </span>
      </div>
    </Link>
  );
  ...
  return (
    <section className="section-off-white overflow-hidden">
      <div className="section-inner">
        ...
        >
          <span className="section-label">{t("home.products.label")}</span>
