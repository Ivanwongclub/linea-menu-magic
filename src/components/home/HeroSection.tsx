...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute top-20 left-[10%] w-32 h-32 border border-foreground/[0.07] rotate-45 transition-transform duration-100 ease-out"
        style={{ transform: `translateY(${parallaxOffset * 0.2}px) rotate(45deg)` }}
      />
      <div 
        className="absolute bottom-32 right-[15%] w-24 h-24 border border-foreground/[0.07] transition-transform duration-100 ease-out"
        style={{ transform: `translateY(${parallaxOffset * 0.6}px)` }}
      />
      <div 
        className="absolute top-1/3 right-[8%] w-16 h-16 bg-foreground/[0.04] transition-transform duration-100 ease-out"
        style={{ transform: `translateY(${parallaxOffset * 0.35}px)` }}
      />
      <div 
        className="absolute bottom-1/4 left-[12%] w-20 h-20 border border-foreground/[0.05] rounded-full transition-transform duration-100 ease-out"
