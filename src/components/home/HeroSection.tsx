    ...
    >
      ...
      >
        ...
        <div 
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='100' height='100' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M50 50m-40 0a40,40 0 1,0 80,0a40,40 0 1,0 -80,0' fill='none' stroke='%23000' stroke-width='0.6'/%3E%3C/svg%3E")`,
      ...
      >
        ...
        <div 
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23000000' fill-opacity='0.35'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
          }}
        />
      </div>
      ...
      <div 
        className="absolute top-20 left-[10%] w-32 h-32 border border-foreground/[0.05] rotate-45 transition-transform duration-100 ease-out"
        style={{ transform: `translateY(${parallaxOffset * 0.2}px) rotate(45deg)` }}
      />
      <div 
        className="absolute bottom-32 right-[15%] w-24 h-24 border border-foreground/[0.05] transition-transform duration-100 ease-out"
        style={{ transform: `translateY(${parallaxOffset * 0.6}px)` }}
      />
      <div 
        className="absolute top-1/3 right-[8%] w-16 h-16 bg-foreground/[0.03] transition-transform duration-100 ease-out"
        style={{ transform: `translateY(${parallaxOffset * 0.35}px)` }}
      />
      <div 
        className="absolute bottom-1/4 left-[12%] w-20 h-20 border border-foreground/[0.04] rounded-full transition-transform duration-100 ease-out"
      ...
      >
        ...
        >
          <Link
            to="/products"
            className="group px-10 py-4 bg-brand-red-accent text-white text-xs tracking-[0.2em] uppercase transition-all duration-300 hover:bg-foreground hover:scale-105"
          >
          ...
          <Link
            to="/contact"
            className="group px-10 py-4 border border-brand-red-accent text-foreground text-xs tracking-[0.2em] uppercase transition-all duration-300 hover:bg-foreground hover:text-background hover:border-foreground hover:scale-105"
          >
            <span className="inline-block transition-transform duration-300 group-hover:translate-x-1">
              聯絡我們
            </span>
