          ...
          {onViewFavorites && (
            <div className="md:hidden mb-6 pb-6 border-b border-border">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 px-4 border border-border rounded-none text-nav-foreground hover:text-nav-hover hover:border-nav-hover transition-colors duration-200"
              >
