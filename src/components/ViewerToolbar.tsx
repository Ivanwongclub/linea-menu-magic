...
const ViewerToolbar = ({
  ...
  const logoElement = embedMode ? (
    <a href={SITE_URL} target="_blank" rel="noopener noreferrer" className="shrink-0">
      <BrandLogo maxHeight={28} variant="light" />
    </a>
  ) : (
  ...
  return (
    <>
      ...
      >
        {/* Left: logo + divider + title + page indicator */}
      ...
      <ShareModal
        ...
        brochureTitle={brochureTitle || title}
